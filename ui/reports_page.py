...
class ReportsPage(QWidget):
    ...
    def _build_ui(self):
        ...
        reload_button = QPushButton("Bericht neu laden"); reload_button.clicked.connect(self.reload_requested)
        export_button = QPushButton("Bericht exportieren"); export_button.clicked.connect(self.export_requested)
        detail_button = QPushButton("Detail anzeigen"); detail_button.clicked.connect(self._detail)
        company_button = QPushButton("Zur Firma wechseln"); company_button.clicked.connect(self._company)
        controls.addWidget(self.filter_box); controls.addStretch(); controls.addWidget(reload_button); controls.addWidget(detail_button); controls.addWidget(company_button); controls.addWidget(export_button)
